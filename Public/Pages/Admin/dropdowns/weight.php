                ...
                <div class="card-body">
                    <div class="title-header option-title">
                        ...
                        <form class="d-inline-flex">
                            <a href="./addweight" class="align-items-center btn btn-theme d-flex">
                   ...
                   <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<li><a href="../App/Logic/weight.php/wdelete?id=' . $row['id'] . '"><i class="ri-delete-bin-line"></a>';
                        ...
                        echo "No records found in the 'Weight' table.";
                    }
