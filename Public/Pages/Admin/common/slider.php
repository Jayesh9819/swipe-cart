    ...
    <div>
        <div class="logo-wrapper logo-wrapper-center">
            <a href="./admin" data-bs-original-title="" title="">
                <img class="img-fluid for-white" src="../Other/Admin_assets/assets/images/logo/full-white.png" alt="logo">
            </a>
            <div class="back-btn">
                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a href="./add-new-category">Add New Category</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a href="./addbreadth">Add Breadth</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-list">
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li>
                                <a href="./seller_id">Seller_id</a>
                            </li>

                            <li>
                                <a href="./addseller_id">Add Seller-id</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        <a class="linear-icon-link sidebar-link sidebar-title" href="javascript:void(0)">
                            <i class="ri-list-settings-line"></i>
                            <span>Style_code</span>
                        </a>
                        <ul class="sidebar-submenu">
                            <li>
                                <a href="./style_code">Style_code</a>
                            </li>

                            <li>
                                <a href="./addstyle_code">Add Style_code</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a href="./addcapacity">Add Capacity</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                <a href="./addmaterial">Add Material</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        <a class="linear-icon-link sidebar-link sidebar-title" href="javascript:void(0)">
                            <i class="ri-list-settings-line"></i>
                            <span>Subcategary</span>
                        </a>
                        <ul class="sidebar-submenu">
                            <li>
                                <a href="./subcategary">Subcategary</a>
                            </li>

                            <li>
                                <a href="./addsubcategary">Add Subcategary</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title link-nav" href="./media">
