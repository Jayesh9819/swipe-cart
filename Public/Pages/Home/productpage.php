                                        ...
                                        <div class="row g-2">
                                            <div class="col-12">
                                                <div class="product-main-1 no-arrow"
                                                    style="height: 500px; width: 250px; object-fit: contain;">
                                                    <div>
                                                        <div class="slider-image">
                                                            <img src="<?php echo $row['main_img']; ?>" id="img-1"
                                                                data-zoom-image="<?php echo $row['main_img']; ?>"
                                                                style="width: 300px; height: 500px; object-fit: contain; display: block;"
                            ...
                            <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="right-box-contain">
                                    ...
                                    <div class="price-rating">
                                        <h3 class="theme-color price">₹.<?php echo $row['coust_price']; ?> <del
                                                class="text-content">₹.<?php echo $row['MRP']; ?></del>
                                    ...
                                    <div class="pickup-box">
                                        ...
                                        <div class="product-info">
                                            <ul class="product-info-list product-info-list-2">
                                                <li>Type : <a
                                                        href="javascript:void(0)"><?php echo $row['sub_category']; ?></a>
                                                </li>
                                ...
                                <div class="product-box-3 wow fadeInUp">
                                    ...
                                    <div class="product-footer">
                                        <div class="product-detail">
                                            ...
                                            <h5 class="price"><span
                                                    class="theme-color">₹.<?php echo $row['coust_price']; ?></span>
