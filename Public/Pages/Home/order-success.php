...
<body class="bg-effect">
    ...
    <?php require "./Public/Pages/Home/Assets/Order_Success/Breadcrumb.php"; ?>


    <?php require "./Public/Pages/Home/Assets/Order_Success/Cart.php"; ?>


    <?php require "./Public/Pages/Home/Assets/Order_Success/Model.php"; ?>
