...
<body class="bg-effect">
    ...
    <?php require "./Public/Pages/Home/Assets/Order_Tracking/Breadcrumb.php"; ?>
    <?php require "./Public/Pages/Home/Assets/Order_Tracking/OrderDetailSection.php"; ?>
    <?php require "./Public/Pages/Home/Assets/Order_Tracking/OrderTableSection.php"; ?>
