<footer class="section-t-space">
        <div class="container-fluid-lg">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            <div class="theme-logo">
                                <a href="index.html">
                                    <img src="../Other/Home_assets/assets/images/logo/1.png" class="blur-up lazyload" alt="">
                                </a>
                            </div>
            ...
            <div class="sub-footer section-small-space">
                ...
                <div class="payment">
                    <img src="../Other/Home_assets/assets/images/payment/1.png" class="blur-up lazyload" alt="">
                </div>
