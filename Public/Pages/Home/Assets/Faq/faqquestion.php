                ...
                <div class="col-12">
                    <div class="slider-4-2 product-wrapper">
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="../Other/Home_assets/assets/images/inner-page/faq/start.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="../Other/Home_assets/assets/images/inner-page/faq/help.png" class="blur-up lazyload" alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="../Other/Home_assets/assets/images/inner-page/faq/price.png" class="blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="../Other/Home_assets/assets/images/inner-page/faq/contact.png" class="blur-up lazyload"
                                        alt="">
                                </div>
