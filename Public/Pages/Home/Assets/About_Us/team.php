                ...
                <div class="col-12">
                    <div class="slider-user product-wrapper">
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="../Other/Home_assets/assets/images/inner-page/user/1.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="../Other/Home_assets/assets/images/inner-page/user/2.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="../Other/Home_assets/assets/images/inner-page/user/3.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="../Other/Home_assets/assets/images/inner-page/user/4.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
