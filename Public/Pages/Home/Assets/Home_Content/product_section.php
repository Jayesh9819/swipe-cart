        ...
        <?php } ?>
                        ...
                        <div class="ratio_156 section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="../Other/Home_assets/assets/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                                    alt="">
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="../Other/Home_assets/assets/images/vegetable/banner/11.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                            ...
                            <div class="category-menu">
                                ...
                                <ul class="product-list border-0 p-0 d-block">
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="../Other/Home_assets/assets/images/vegetable/product/23.png"
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="../Other/Home_assets/assets/images/vegetable/product/24.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="../Other/Home_assets/assets/images/vegetable/product/25.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li class="mb-0">
                                        <div class="offer-product">
                                            <a href="product-left-thumbnail.html" class="offer-image">
                                                <img src="../Other/Home_assets/assets/images/vegetable/product/26.png"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                ...
                                <div class="review-box">
                                    ...
                                    <div class="review-profile">
                                        <div class="review-image">
                                            <img src="../Other/Home_assets/assets/images/vegetable/review/1.jpg"
                ...
                <div class="col-xxl-9 col-xl-8">
                    ...
                    <?php
                    include "./Public/Pages/Home/Assets/Home_Content/product.php";
                    ?>
                        ...
                        <div class="row g-md-4 g-3">
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="../Other/Home_assets/assets/images/vegetable/banner/9.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                            ...
                            <div class="col-md-6">
                                <div class="banner-contain hover-effect">
                                    <img src="../Other/Home_assets/assets/images/vegetable/banner/10.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                                            <h3 class="text-exo">50% offer</h3>
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="../Other/Home_assets/assets/images/vegetable/banner/12.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                    <div class="banner-details p-center-left p-4">
                                        <div>
                            ...
                            <div class="col-xxl-4 col-xl-12 col-md-5">
                                <a href="shop-left-sidebar.html" class="banner-contain hover-effect h-100">
                                    <img src="../Other/Home_assets/assets/images/vegetable/banner/13.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                    ...
                    <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="../Other/Home_assets/assets/images/vegetable/blog/1.jpg" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="../Other/Home_assets/assets/images/vegetable/blog/2.jpg" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="../Other/Home_assets/assets/images/vegetable/blog/3.jpg" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>
