                                                ...
                                                if (xhr.readyState === 4) {
                                                    if (xhr.status === 200) {
                                                        ...
                                                        if (response.success) {
                                                            ...
                                                            window.location
                                                        .reload(); // Reload the page after successful addition
                                                        } else {
                                                            alert("Error adding item to the cart: " + response
                                                                .message);
                                                        }
                                                    } else {
                                        ...
                                        <div class="section-t-space">
                                            <div class="banner-contain">
                                                ...
                                                <div class="banner-details p-center p-4 text-white text-center">
                                                    <div>
                                                        <h3 class="lh-base fw-bold offer-text">Get $3 Cashback! Min
                                                            Order of $30</h3>
                                                ...
                                                <div class="col-xxl-8 col-xl-12 col-md-7">
                                                    <div class="banner-contain hover-effect">
                                                        ...
                                                        <div class="banner-details p-center-left p-4">
                                                            <div>
                                                                <h2 class="text-kaushan fw-normal theme-color">Get Ready
                                                                    To</h2>
                                                                <h3 class="mt-2 mb-3">TAKE ON THE DAY!</h3>
                                                                <p class="text-content banner-text">In publishing and
                                                                    graphic design, Lorem
                                                                    ipsum is a placeholder text commonly used to
                                                                    demonstrate.</p>
                                                                <button
                                                                    onclick="location.href = 'shop-left-sidebar.html';"
                                                                    class="btn btn-animation btn-sm mend-auto">Shop Now
                                                                    <i
                                                ...
                                                <div class="col-xxl-4 col-xl-12 col-md-5">
                                                    <a href="shop-left-sidebar.html"
                                                        ...
                                                        <div class="banner-details p-center-left p-4 h-100">
                                                            <div>
                                                                <h2 class="text-kaushan fw-normal text-danger">20% Off
                                                                </h2>
                                                                <h3 class="mt-2 mb-2 theme-color">SUMMRY</h3>
                                                                <h3 class="fw-normal product-name text-title">Product
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </a>
                                                        ...
                                                        <div class="offer-product">
                                                            ...
                                                            <div class="offer-detail">
                                                                <div>
                                                                    <a href="product-left-thumbnail.html"
                                                                        class="text-title">
                                                                        <h6 class="name">Good Life Refined Sunflower Oil
                                                                        </h6>
                                                                    </a>
                                                                    <span>1 L</span>
                                                                    <h6 class="price theme-color">$ 10.00</h6>
                                            ...
                                            <div class="banner-contain hover-effect">
                                                ...
                                                <div class="banner-details p-center banner-b-space w-100 text-center">
                                                    <div>
                                                        ...
                                                        <h5 class="lh-sm mx-auto mt-1 text-content">Save up to 5% OFF
                                                        </h5>
