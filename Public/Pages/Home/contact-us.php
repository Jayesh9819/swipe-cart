...
<body class="bg-effect">
    ...
    <!-- breadcrumb  -->
    <?php require "./Public/Pages/Home/Assets/Contact/breadcrumb.php"; ?>
    <?php require "./Public/Pages/Home/Assets/Contact/contactbox.php"; ?>
    <?php require "./Public/Pages/Home/Assets/Contact/map.php"; ?>
