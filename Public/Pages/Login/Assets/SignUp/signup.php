                   ...
                   <div class="log-in-box">
                       ...
                       <div class="input-box">
                           <form class="row g-4" action="../App/Logic/Login.php?action=create_user " method="post">
                               ...
                               <div class="col-12">
                                   <div class="form-floating theme-form-floating">
                                       <input type="password" class="form-control" name="con-pass" id="confirm-password" placeholder="Password" required>
                           ...
                           <ul>
                               <li>
                                   <a href="https://accounts.google.com/signin/v2/identifier?flowName=GlifWebSignIn&amp;flowEntry=ServiceLogin" class="btn google-button w-100">
                                       <img src="../Other/Home_assets/assets/images/inner-page/google.png" class="blur-up lazyload" alt="">
                                       Sign up with Google
                                   </a>
                               </li>
                               <li>
                                   <a href="https://www.facebook.com/" class="btn google-button w-100">
                                       <img src="../Other/Home_assets/assets/images/inner-page/facebook.png" class="blur-up lazyload" alt=""> Sign up with Facebook
                                   </a>
                               </li>
                           </ul>
                       </div>
