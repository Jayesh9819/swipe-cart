...
class hsn{
     public function hsn()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("INSERT INTO hsn (name, value) VALUES (?, ?)");
    ...
    public function hsndelete()
    {
        ...
        if (isset($_GET['id'])) {
            ...
            $delete_sql = "DELETE FROM hsn WHERE id = $category_id";
