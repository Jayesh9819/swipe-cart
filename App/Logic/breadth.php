 ...
 function breadth()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("INSERT INTO breadth (name, status) VALUES (?, ?)");
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    header("Location: ../../../index.php/breadth");
                    exit;
                } else {
     ...
     public function delete()
    {
        ...
        if (isset($_GET['id'])) {
            ...
            $delete_sql = "DELETE FROM breadth WHERE id = $category_id";

            if ($conn->query($delete_sql) === TRUE) {
                header('Location: ../../../index.php/breadth');
                $response['success'] = true;
                $response['message'] = "breadth deleted successfully!";
            } else {
