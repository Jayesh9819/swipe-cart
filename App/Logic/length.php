 ...
 function length()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("INSERT INTO length (name, status) VALUES (?, ?)");
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    header("Location: ../../../index.php/length");
                    exit;
                } else {
     ...
     public function delete()
    {
        ...
        if (isset($_GET['id'])) {
            ...
            $delete_sql = "DELETE FROM length WHERE id = $category_id";

            if ($conn->query($delete_sql) === TRUE) {
                header('Location: ../../../index.php/length');
                $response['success'] = true;
                $response['message'] = "length deleted successfully!";
            } else {
