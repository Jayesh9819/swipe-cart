 ...
 function capacity()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("INSERT INTO capacity (name, status) VALUES (?, ?)");
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    header("Location: ../../../index.php/capacity");
                    exit;
                } else {
     ...
     public function delete()
    {
        ...
        if (isset($_GET['id'])) {
            ...
            $delete_sql = "DELETE FROM capacity WHERE id = $category_id";

            if ($conn->query($delete_sql) === TRUE) {
                header('Location: ../../../index.php/capacity');
                $response['success'] = true;
                $response['message'] = "capacity deleted successfully!";
            } else {
